...
cards:
  # ============================================================
  # P2 Fan light control
  # ============================================================
  - type: custom:mushroom-light-card
    entity: light.fan_master_2_speed
  ...
  - type: custom:mushroom-legacy-template-card
    ...
    icon: mdi:fan-auto
    icon_color: >
      {% if is_state('input_boolean.p2_fan_auto_speed','on') %}
      orange{% else %}grey{% endif %}
    entity: input_boolean.p2_fan_auto_speed
    tap_action:
      action: toggle
    card_mod:
      style: |
